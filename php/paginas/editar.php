...
if ($form){
    ...
    iduSQL("UPDATE papelaria SET nome = '$nome', preco = $preco, quantidade = $quantidade WHERE id = $id");
}
        ...
        <?php if ($form):?>
            <div class="row caixas">
                <div class="col-12 bv_titulo p-4">
                    PRODUTO (<?= $id;?>) EDITADO COM SUCESSO!
                    <br><br>
                    <a href="editar.php">
                    ...
                    <table class="mx-auto w-100">
                        ...
                        <?php foreach($papelaria as $p): ?>
                            ...
                            <tr>
                                ...
                                <td><?= $p["quantidade"]; ?></td>
                                <td>
                                    <form action="editar_saida.php">
                                        <button name="id" value="<?= $p["id"];?>">Editar</button>
                                    </form>
                                </td>
                            </tr>
