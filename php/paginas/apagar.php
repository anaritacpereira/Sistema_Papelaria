...
if($form){
    $id=intval($_GET["id"]);
    iduSQL("DELETE FROM papelaria WHERE id=$id");
}
            ...
            <div class="row caixas mt-3">
                ...
                <nav class="col-12 navbar navbar-expand-lg">
                        <div class="collapse navbar-collapse justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu active" aria-current="page" href="apagar.php">APAGAR PRODUTO</a>
                            </li>
                            <li class="nav-item">
            ...
            <?php if ($form):?>
                <div class="row caixas">
                    <div class="col-12 bv_titulo p-4">
                        PRODUTO (<?= $id;?>) APAGADO COM SUCESSO!
                        <br><br>
                        <a href="apagar.php">
                        ...
                        <table class="mx-auto w-100">
                            ...
                            <?php foreach($papelaria as $p): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="">
                                            <button name="id" value="<?= $p["id"];?>">Apagar</button>
                                        </form>
                                    </td>
                                </tr>
