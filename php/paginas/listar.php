...
$form = isset($_GET["escolha"]) && isset($_GET["ordem"]);

if($form){
    $escolha=$_GET["escolha"];
    $ordem = $_GET["ordem"];
    $papelaria = selectSQL("SELECT * FROM papelaria ORDER BY $escolha $ordem");
            ...
            <div class="row caixas mt-3">
                ...
                <nav class="col-12 navbar navbar-expand-lg">
                        <div class="collapse navbar-collapse justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu active" aria-current="page" href="listar.php">LISTAR PRODUTOS</a>
                            </li>
                            <li class="nav-item">
